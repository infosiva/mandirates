...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="py-14 px-4 sm:px-6 max-w-5xl mx-auto border-t border-green-100">
      <motion.div
      ...
      >
        <motion.div variants={itemVars as Parameters<typeof motion.div>[0]['variants']} className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm">Three steps to live mandi prices</p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connecting line — desktop only */}
          <div className="hidden md:block absolute top-8 left-1/3 right-1/3 h-px bg-green-200" aria-hidden="true" />
          ...
          {siteConfig.howItWorks.map((step) => (
            ...
            >
              ...
              <div className="text-3xl font-black text-green-200 tabular-nums leading-none">
